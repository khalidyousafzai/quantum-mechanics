...
analog electronics	مماثل برقیات
...
building	عمارت
build a function	تفاعل تیار کرنا
bulb	بتی
bump	موڑا
but	تاہم
bypass capacitor	قصری کپیسٹر
byte, 8-bit (binary) data, (bit=binary ??)	بائٹ، ہشتم دہری عدد
cable 	رسی
calculus	علم الاحصاء
calculate, compute	بذریعہ حساب تلاش کریں
calculator	کیلکولیٹر
calculus	احصاء
calculus of differences	الاحصاء فرقیات
calibration	پیمانہ بندی
californium	کیلی فورنیم
cam shaft	کیم دھرا
cancel (common factor}	مشترک جزو ضربی کاٹنا، منسوخ کرنا
cancellation laws (matrix multiplication)	قواعد تنسیخ
cancer: anna kane laird, Banjamin Gompertz	سرطان: اینا کین لایرڈ، بنجامن گامپرٹز
canonical	باضابطہ
canonical minterm, non-canonical minterm	تفصیلی رکنِ ضرب، سادہ رکنِ ضرب
Cantor-Dedekind axiom	مسلملہ کنتور اور دے دے کند
capacitance, inductance	برقی گنجائش، امالہ یا امالیت
capacitor, inductor	برق گیر، امالہ گیر
capacitive, inductive	برق گیر کی خاصیت، امالہ کی خاصیت رکھنا، امالی، برق گیری
capacity, rating	استعداد
carbon dating	کاربنی تعین زمان
cardiac output	اخراج قلب
cardiod [r=a(1-cos x)]	قلب نما
carrier of energy	انتقالِ توانائی
carrier frequency, modulating frequency, carrier wave	تعددِ سوار، تعددِ سواری، سوار موج، سواری موج
carry, transfer	منتقل
Carry , borrow, sum, end carry	حاصل، ادھار، جمع،بقایا، آخری حاصل
cart	ریڑھی
Cartesian co-ordinates system	کارتیسی نظامِ محدد
carton	گتے کا ڈبا
cases: three cases	تین صورتیں
catalyst, autocatalyst	عمل انگیز، خود عمل انگیز
catenary (maths: hanging chain)	لیزم
cathode	منفی برقیرہ
cation	مثبت بارداریہ
Cauchy	کوشی
Cauchy: Augustin Louis Cauchy	آگستن لوئی کوشی
Cauchy condensation test	کوشی پرکھ جمود
Cauchy's determinant	کوشی مقطع
Cauchy-Riemann equation	کوشی ریمان مساوات
Cauchy-Schwarz inequality, Herman Amandus Schwarz	کوشی شوارز عدم مساوات، ہرمن امندس شوارز
caution	انتباہ
Cavalieri’s theorem ( Bonaventura Francesco Cavalieri)	مسئلہ کوالئیرے (بوناونتورا کوالئیرے)
ceiling and floor function	عدد صحیح چھت تفاعل، کم ترین عدد تفاعل
center of gravity	مرکز ثقل
center of mass	مرکز کمیت
central angle	وسطی زاویہ
centrifugal force	مرکز گریز قوت
centrifugal term	مرکز گریز جزو
centroid	وسطانی مرکز
celsius, fahrenheit	سیلسیئس، فارن ہائیٹ
centripetal force	مرکز مائل قوت
chance	امکان، اتفاق
chaos	ابتری
chamber, turbine chamber	خانہ، چرخی خانہ
chapter	باب
characteristic, characteristics	خاصیت، خصوصیات ، خصلت
characteristic: magnitude characteristic, phase characteristic (Bode plot)	مقداری خصلت، زاویائی خصلت
characteristics	خصوصیات، خط، خطِ منحنی، منحنی
characteristic equation,  (differential equations as^2+bs+c=0)	امتیازی مساوات
charge, free, bound	آزاد اور بندھا بار
charge, discharge a capacitor	بار بھرنا، بار کا نکاس
charged	بار بردار
Charles Dalziel (electrical shock)	
chain rule (differentiation)	زنجیری طریقہ، زنجیری قاعدہ
...
complex number	مخلوط عدد: ایک حقیقی عدد جو کسی فرضی عدد کے ساتھ شامل کر لیا جائے
...
continuous field, discontinuous	بلا جوڑ میدان، جوڑ دار
...
critical point, value	فاصل نقطہ، فاصل قیمت، نقطہ فاصل
...
DC separately excited generator	یک سمتی بیرونی ہیجان جنریٹر
...
Edward Lowry Norton: norton theorem	ایڈورڈ لوری نارٹن
...
Ernest Rutherford	ارنسٹ ردرفورڈ
error	خلل
...
factor	جُزو ضربی: اِن اعداد میں سے ایک عدد جنھیں آپس میں ضرب دینے سے کوئی خاص عدد حاصل ہوتا ہے
...
fuse	فتیلہ
gabriel	جبرائیل
gain, voltage gain, current gain, transconductance gain, transresistance gain	افزائش، افزائشِ برقی دباؤ، افزائش برقی رو، افزائش موصلیت-نما، افزائش مزاحمت-نما
...
half adder	نصف جمع کرنے والا دور
half life	نصف زندگی
...
identity: euler identity	مماثل: یولر مماثل
...
input bias current	داخلی میلان برقی رو
...
inverting, non-inverting input	مثبت مداخل، منفی مداخل
...
leading angle, lagging angle	آگے زاویہ، پیچھے زاویہ
...
liquid	مائع
list	درج کرنا، فہرست
live wire, hot wire	زندہ تار، گرم تار
...
matrix: entry, row, column	قالب، اندراجات، صف، قطار
...
moment: bending moment	خماو کا معیار اثر
...
Normal, binormal , principal normal (maths)	عمودی، خطِ عمود، دوہرا عمودی، صدر عمودی 
...
Pauli spin matrices (Wolgang Ernst Pauli)	ولگنگ ارنسٹ پالی، پالی قالب چکر
peak	چوٹی
peel off	چھیلنا
pendulum	لٹکن
percentile	صدویہ
...
polar representation, polar form	قطبی روپ
...
random; drawn at random	بلا منصوبہ
...
relative frequency, relative humidity	اضافی ارتعاش، اضافی رطُوبت
...
roots of equation (in urdu it is jazar)	مساوات کے جذر
...
separately excited DC machine	بیرونی ہیجان یک سمتی مشین، خارجی ہیجان شدہ
...
singularity, essential singularity	ندرت، لازمی ندرت
...
spectrum: discrete line spectrum	انفرادی لکیری طیف، غیر مسلسل طیف
...
time: high time, low time,response or delay time	بلند دورانیہ، پست دورانیہ،دورانیہ ردِ عمل 
...
Tolerance: values have 5% tolerance	خلل: قیمت میں پانچ فی صد خلل پایا جا سکتا ہے۔
topic	موضوع
torsion	مروڑ
...
wave: vibration, vibrating body	ایک ارتعاش، مرتعش جسم
