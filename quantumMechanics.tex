...
\pgfplotsset{compat=1.18}							% 5june 2026 onwards
\pgfplotsset{table/search path={./tex/tables},}
...
%============================                                                            
%=================================
\DeclareRobustCommand{\s}{\text{\reflectbox{$\&$}}}
...
\graphicspath{{./fig/figFrontPage/}{./fig/figCalculusLimits/}{./fig/figCalculusDerivatives/}{./fig/figCalculusIntegration/}{./fig/figCalculusApplicationsOfIntegrals/}{./fig/figCalculusTechniquesOfIntegration/}{./fig/figQuantumMechanicsInThreeDimensions/}}%paths to figures


%
\includeonly{./tex/quantumPreface,./tex/prefaceFirstBook,./tex/quantumTheWaveFunction,./tex/quantumMechanicsTime_independentSchrodingerEquation,./tex/quantumFormalism,./tex/quantumMechanicsInThreeDimensions,./tex/quantumIdenticalParticles,./tex/quantumTimeIndependentPertubationTheory,./tex/quantumTheVariationalPrinciple,./tex/quantumTheWKBapproximation,./tex/quantumTimeDependentPertubationTheory,./tex/quantumTheAdiabaticApproximation,./tex/quantumScattering,./tex/quantumAfterword,./tex/quantumAppendix}
%
%\includeonly{./tex/quantumPreface,./tex/prefaceFirstBook,./tex/quantumAppendix}
%
...
\binoppenalty=\maxdimen		%these two lines avoids line breaks in inline equations
\relpenalty=\maxdimen
...
\include{./tex/quantumPreface}
\newpage
\addcontentsline{toc}{chapter}{پہلی کتاب کا دیباچہ}
...
\include{./tex/quantumMechanicsTime_independentSchrodingerEquation}
...
%de-comment the following if answers at the end are to be added
\begin{comment}
\chapter*{جوابات}
...
\appendix
%changing numbering scheme to show equation numbers etc as "A-??"
\renewcommand{\theequation}{A-\arabic{equation}}  
\renewcommand{\thequestioncounter}{A-\arabic{questioncounter}} 
\renewcommand{\theexamplecounter}{A-\arabic{examplecounter}} 
\renewcommand{\thesection}{A-\arabic{section}} 



\include{./tex/quantumAppendix}
%\include{./tex/quantumAppendixLinearAlgebra}
%
