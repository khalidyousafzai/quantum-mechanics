...
\includeonly{./tex/calculusPreface,./tex/prefaceFirstBook,./tex/quantumTheWaveFunction,./tex/quantumMechanicsTime_independentSchrodingerEquattion,./tex/quantumIdenticalParticles}
%
...
%
%\includeonly{./quantumMechanicsPreface,./tex/prefaceFirstBook,./tex/questions}%
