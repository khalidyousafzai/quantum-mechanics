...
\حصہ{مسئلہ حر ناگزر}
\جزوحصہ{حر ناگزر عمل} 
فرض کریں ایک کامل   رقاص   انتصابی سطح  میں بغیر کسی رگڑ یا ہوائی مزاحمت کے آگے پیچھے ارتعاش کرتا ہے۔ اگر آپ اس   رقاص   کو  جھٹکے سے ہلائیں تو یہ افراتفری کے ساتھ  حرکت کرنے لگے گا،  لیکن اگر آپ بغیر جھٹکا دیے    رقاص   کو آہستہ آہستہ ایک مقام سے دوسرے  مقام منتقل کریں (شکل \حوالہ{شکل_حرارت_نا_گزر_آہستہ_منتقلی})    تو   یہ    اسی سطح  (یا اس کی  متوازی سطح)  میں شائستگی اور روانی سے،  اسی حیطہ کے ساتھ جھلولتا رہے گا۔\ترچھا{ بیرونی کیفیت  کی بہت آہستہ  تبدیلی}  ہی \اصطلاح{ حر ناگزر}\فرہنگ{حر ناگزر}\حاشیہب{adiabatic}\فرہنگ{adiabatic} عمل کی پہچان ہے۔ دھیان رہے کہ یہاں دو مختلف   وقتوں کی بات کی جا رہی ہے:  نظام کی اپنی  حرکت (  جو یہاں   رقاص   کے  ارتعاش کا دوری عرصہ ہوگا)   کو ظاہر کرنے والا" اندرونی"  وقت \عددی{T_i}،  اور نظام  کی مقادیر معلوم میں  نمایاں تبدیلی( مثلاً،  لرزتے ہوئے چبوترے  پر نصب   رقاص   کی صورت میں چبوترے کی لرزش کا دوری عرصہ)  کو ظاہر کرنے والا " بیرونی"  وقت \عددی{T_e}۔ حر ناگزر عمل میں \عددی{T_e \gg T_i} ہوگا۔
...
\item
فرض کریں ہم کنویں کو ابتدائی چوڑائی کے دگنی چوڑائی تک پھیلنے دیتے ہیں،  یوں  "بیرونی"  وقت \عددی{w(T_e) = 2a} ہوگا۔  (ابتدائی)  زمینی حال کے تابع وقت قوت نما  جزو ضربی کا دوری عرصہ ،   "اندرونی" وقت ہوگا۔ وقت \عددی{T_e} اور \عددی{T_i} کا  تعین کرکے،  دکھائیں  کہ  حر ناگزر   طریق  سے مراد \عددی{\alpha \ll 1} ہوگا،  لہٰذا  تکمل کے
...
\end{align}
وقت کے ساتھ تبدیل ہوتے ہوئے \عددی{E_n} کی صورت میں "معیاری"   ہیّتی جزو ضربی کو عمومیت دیتا ہے۔ (  ہمیشہ کی طرح میں اس کو  عددی سر \عددی{c_n (t)} میں ضم  کر سکتا تھا،  لیکن غیر تابع وقت ہیملٹنی کی صورت میں بھی یہ پایا جاتا ہے،  لہٰذا  تابعیت  وقت کے اس حصے  کو صریحاً  لکھنا موزوں ہوگا۔) 
...
%=========================
%KKK edited till here 15 feb 2022
\ابتدا{مثال}
...
\end{align}
مسئلہ حر ناگزر کہتا ہے کہ \عددی{
T_e \gg T_i
...
} ہوگا یو حر ناگزر تخمین سے مراد \عددی{\omega \ll \omega_1} ہوگا غیر مضطرب تفاعلات موج کے دور کے لحاظ سے میدان آہستہ گھومتا ہے حر ناگزر صورت \عددی{
\lambda \cong \omega_1
} میں درج ذیل ہوگا ۔
\begin{align}
...
\end{axis}
\end{tikzpicture}
\caption{غیر حر ناگزر صورت   \عددی{(\omega\gg\omega_1)}   میں تحویلی  احتمال  (مساوات \حوالہء{10.34})۔}
...
\end{figure}
 ...
 کرہ کی سطح پر ایک بند راہ پر چلتے ہوئے حر ناگزر منتقلی کی ایک مثال فوکالٹ  رقاص  ہے جہاں چبوترا کو اٹھا کر چلنے کی بجائے زمین کے گھومنے کو یہ کام سونپا جاتا ہے خط عرض بلد \عددی{\theta_0} درج ذیل ٹھوس زاویہ بناتا ہے  (شکل   \حوالہ{شکل_حرارت_نا_گزر_فوقو_رقاص_ایک_دن})۔ 
\begin{align}
...
\gamma_n (T)
} ہیّت بیری کہلاتا ہے دھیان رہے ہیں کہ جب تک تبدیلی اتنی آہستہ ہو کہ قیاس حر ناگزر کے شرائط مطمئن ہوتے ہوں \عددی{
\gamma_n (T)
} کی قیمت صرف اس راہ پر منحصر ہوگی جس پر چلا جائے نہ کہ راہ پر چلنے کی رفتار پر اس کے برعکس مجموعی حرکی ہیّت 
\begin{align*}
...
\kvec{B} (t)
} ایک مستقل زاویہئی سمتی رفتار \عددی{\omega} سے استقبالی حرکت کرتا ہو میدان بھی کے ساتھ ساتھ ہم میدان الیکٹران کی صورت میں مساوات 10.33 ٹھیک ٹھیک حل دیتی ہے حر ناگزر صورت \عددی{
\omega \ll \omega_1
} میں 
\begin{align}
...
\end{align}
جہاں \عددی{\Lambda} مقام اور وقت کا کوئی بھی تفاعل ہو سکتا ہے اسے ماپ تبادلہ کہا جاتا ہے اور جیسا آپ مساوات 10.63 استعمال کرتے ہوئے دیکھ سکتے ہیں کہ اس کا میدانوں پر کوئی اثر نہیں ہوگا کوانٹائی میکانیات میں مخفیہ زیادہ اہم کردار ادا کرتی ہے چونکہ ہیملٹنی کو \عددی{\varphi} اور \عددی{\kvec{A}} کی صورت میں نہ کہ \عددی{\kvec{E}} اور \عددی{\kvec{B}} کی صورت میں بیان کیا جاتا ہے 
\begin{align}
...
\end{figure}
 ...
 فرض کریں ایک ذرہ کو رداس \عددی{b} کے دائرہ پر رہنے کا پابند بنایا جائے اس دائرے کے محور پر رداس \عددی{
a < b
...
\kvec{r} - \kvec{R}
} کا تفاعل ہے نہ کہ \عددی{\psi_n} کی طرح علیحدہ علیحدہ \عددی{\kvec{r}} اور \عددی{\kvec{R}} کا تفاعل آئیے اب اس ڈبہ کو لمبے لچھے کے گرد ایک پھیرا دیتے ہیں یہاں اس عمل کا حر ناگزر ہونے کے بھی ضرورت نہیں ہے ہیّت بیری تعین کرنے کی خاطر ہمیں مقدار \عددی{
\langle \psi_n | \nabla \psi_n \rangle
...
\end{align*}
جہاں \عددی{f (t)} آہستہ آہستہ صفر سے \عددی{\infty} تک بڑھتا ہے مسئلہ حر ناگزر کے تحت یہ ذرہ ارتقائی ہیملین کے زمینی حال میں ہی رہے گا 
\begin{enumerate}[a.]
\item
وقت \عددی{t \to \infty} پر زمینی حال کا خاکہ بنائیں اشارہ: یہ اس لامتناہی چوکور کنویں کا زمینی حال ہوگا جس میں \عددی{a/2 + \epsilon} پر ناقابل گزر رکاوٹ ہو آپ دیکھیں گے کہ ذرہ بائیں ہاتھ کے نسبتاً بڑے حصہ میں رہنے کا پابند ہوگا 
\item
...
\end{align}
\item
دکھائیں کہ حر ناگزر تخمین کی صورت میں کلاسیکی مقام مساوات 10.91 درج ذیل روپ اختیار کرتی ہے \عددی{
x_c (t) \cong f (t)
} سیاق و سباق کے لحاظ سے یہاں حر ناگزر تفاعل \عددی{ f} کہ وقتی تفرق پر کیا پابندی عائد کرتی ہے اشارہ \عددی{
\sin [\omega (t - t')]
} کو \عددی{
...
\انتہا{سوال}
\ابتدا{سوال} 
حر ناگزر تخمین کو مساوات 10.12 میں عددی سر \عددی{c_m(t)} کے حر ناگزر تسلسل کا پہلا جزو قصور کیا جا سکتا ہے فرض کریں نظام \عددی{ n} وی حال سے آغاز کرتا ہے حر ناگزر تخمین میں یہ ایک اضافی تابع وقت ہندسی ہیّتی جزو ضربی مساوات 10.21 کے علاوہ \عددی{ n} وی حال میں ہی رہے گا 
\begin{align*} 
