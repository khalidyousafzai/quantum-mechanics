...
\psi^i (x)
} ہی رہتا ہے  (شکل  \حوالہ{شکل_حرارت_نا_گزر_ابتدائی_حال_کنواں_دیوار}-ج)  جو نئے ہیملٹنی کے امتیازی حالات کا ایک پیچیدہ خطی جوڑ ہوگا سوال 2.38 یہاں توانائی کی بقا ہوگی کم ازکم اس کی توقعاتی قیمت کی ضرور ہوگی جیسا اچانک رکاوٹ ہٹانے سے خلا میں گیس کی آزادانہ پھیلانے  سے کوئی کام نہیں ہوتا ۔
...
w(T_e) = 2a
} ہوگا ابتدائی زمینی حال کے تابع وقت قوت نمائی جزو ضربی کا دورانیہ اندرونی وقت ہوگا وقت \عددی{T_e} اور \عددی{T_i} تعین کرکے دیکھائے کے حرکت نہ گزر  صورتحال سے مراد \عددی{\alpha \ll 1} ہوگا جس کے تحت تکمل کے دائرہ کار پر \عددی{
...
\انتہا{مثال}
\ابتدا{سوال}
تصدیق کیجئے گا کہ مساوات 10.25 کی ہيملٹنی کیلئے مساوات 10.31 تابع وقت مساوات شروڈنگر کو مطمئن کرتی ہے ساتھ ہی مساوات 10.33 کی تصدیق کریں اور دکھائیں کے عددی سروں کے مربّعوں کا مجموعہ ایک ہوگا جو معمول زنی کی شرط ہے 
\انتہا{سوال}
%=========================
...
\end{align}
جہاں سیدھی پہنچتی شعاع کا تفاعل موج \عددی{\Psi_0} ہے اور متغیر \عددی{H} کی بنا پر شعاع کا اضافی ہیّت \عددی{\Gamma} ہے جس کا کچھ حصہ ہرکی اور کچھ حصہ ہندسی ہوگا اس صورت میں درج ذیل ہوگا 
\begin{align}
...
\begin{enumerate}[a.]
\item
لامتناہی چوکور کنویں کی چوڑائی  \عددی{w_1} سے بھڑ کر \عددی{w_2} ہونے کی صورت میں مساوات 10.42 استعمال کرتے ہوئے ہندسی تبدیلی ہیئت تلاش کریں 
\item
...
جہاں \عددی{
\Phi = \pi a^2 B
} لچھے سے گزرتا ہوا  مقناطیسی بہاؤ ہوگا ساتھ ہی لچھا خود غیر باردار ہے لہذا غیر سمتی مخفیہ \عددی{\varphi} صفر ہے ایسی صورت میں ہیملٹنی مساوات 10.65درج ذیل روپ اختیار کرتی ہے 
\begin{align}
...
\nabla \times \kvec{A} = 0
} ہوگا تاہم \عددی{\kvec{A}} خود غیر صفر ہے اگرچہ میں فرض کرتا ہوں کہ \عددی{\kvec{A}} ساکن ہے اس ترکیب کو تابع وقت مخفیا کے لئے عمومیت دی جا سکتی ہے مخفی توانائی \عددی{V} جس میں برقی حصہ \عددی{q \psi} شامل یا غیر شامل ہو سکتا ہے کی مساوات شروڈنگر 
\begin{align} 
...
بظاہر \عددی{\Psi'} بغیر \عددی{\kvec{A}} مساوات شروڈنگر کو مطمئن کرتا ہے مساوات 10.80 کا حل تلاش کرنے کے بعد بغیر گردش سمتی مخفیہ سے پیدا تصحیح کو شامل کرنا  حقیر سا کام ہو گا:  ہمیں صرف ہیتی جزو ضربی \عددی{e^{i g}} ساتھ منسلک کرنا ہوگا۔
...
\kvec{B} = 0
} ہو تاہم \عددی{\kvec{A}} جس سے مساوات 10.66 پیش کرتی ہے غیر صفر ہوگا اور دونوں اطراف \عددی{V} کی قیمت ایک  جیسی تصور کرتے ہوئے اختتامی نقطہ پر دونوں شعاعوں میں ہیتی فرق پایا جائے گا 
\begin{align}
...
\begin{enumerate}[a.]
\item
وقت \عددی{t \to \infty} پر زمینی حال کا خاکہ بنائیں اشارہ: یہ اس لامتناہی چوکور کنویں کا زمینی حال ہوگا جس میں \عددی{a/2 + \epsilon} پر ناقابل گزر رکاوٹ ہو آپ دیکھیں گے کہ ذرا بائیں ہاتھ کے نسبتا بڑے حصہ میں رہنے کا پابند ہوگا 
\item
...
\item
\عددی{T} اور \عددی{\delta} کی انہی قیمتوں کے لئے زمینی حال تفاعل موج ترسیم کریں آپ دیکھیں گے کہ رکاوٹ بلند ہونے سے کس طرح ذراہ کنویں کے بائیں نصف حصہ میں رہنے کا پابند ہو جاتا ہے 
\end{enumerate}
\انتہا{سوال} 
\ابتدا{سوال}
