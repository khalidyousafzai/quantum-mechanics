...
\newcommand{\برا}{برا}			% bra   (quantum mech)
\newcommand{\کٹ}{کٹ\,}		% ket (quantum mech)
...
%\newcommand{\مکالمہ}[1]{”{#1}“}  %urdu quotation marks. fails if\\عددی{} included. needs further study
%===============================
