...
\end{tikzpicture}
\caption{متناہی چکور کنواں (مساوات \حوالہء{2.145})۔}
\label{شکل_غیر-تابع_شروڈنگر_متناہی_کنواں}
\end{figure}
...
\end{axis}
\end{tikzpicture}
\caption{ترسیمی حل برائے مساوات \حوالہء{2.156} جہاں \عددی{z_0=8} لیا گیا ہے (جفت حالات)۔}
...
\end{tikzpicture}
\caption{
ترسیلی مستقل بطور توانائی کا تفاعل (مساوات \حوالہء{2.169})۔
}
...
\end{tikzpicture}
\caption{
عمودی چٹان سے بکھراو (سوال \حوالہء{2.35})۔
}
\label{شکل_غیر-تابع_شروڈنگر_عمودی_چٹان_بکھراو}
\end{figure}
...
\end{tikzpicture}
\caption{
دوہرا چکور کنواں (سوال \حوالہء{2.47})۔
}
\label{شکل_غیر-تابع_شروڈنگر_دوہرا_چکور_کنواں}
\end{figure}
...
\draw[decorate,decoration={brace,amplitude=10pt,mirror}](-3,-0.5)--(-1.3,-0.5)node[pos=0.5,below,yshift=-1em]{\RL{خطہ-1}};
\draw[decorate,decoration={brace,amplitude=10pt,mirror}](-1.25,-0.5)--(2.5,-0.5)node[pos=0.5,below,yshift=-1em]{\RL{خطہ-2}};
\draw[decorate,decoration={brace,amplitude=10pt,mirror}](2.6,-0.5)--(3.75,-0.5)node[pos=0.5,below,yshift=-1em]{\RL{خطہ-3}};
\end{tikzpicture}
\caption{
مقامی اختیاری مخفیہ  (جو  خطہ-2  کے علاوہ  \عددی{V(x)=0} ہے)  سے بکھراو (سوال \حوالہء{2.52})۔
}
