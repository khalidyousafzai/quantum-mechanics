...
\newcommand*{\mat}[1]{\operatorname{\mathbf{#1}}} %bold upright Matrix operators (quantum mechanics)
\newcommand*{\op}[1]{\operatorname{#1}} %Operators such as Legendre's  function
