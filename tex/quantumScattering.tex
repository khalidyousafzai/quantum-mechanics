...
\موٹا{سخت  کرہ   بکھراو}۔ فرض کریں ہدف رداس \عددی{R} کا ایک سخت بھاری گیند ہے،  جبکہ آمدی ذرہ ہوائی بندوق کا  چھرا  ہے،   جو   ٹپا   کھا  کر مڑتا ہے  (شکل \حوالہ{شکل_بکھراو_سخت_کرہ_لچکدار})۔ زاویہ \عددی{\alpha} کی  صورت   میں ٹکراو مقدار معلوم \عددی{b=R\sin\alpha} اور زاویہ بکھراو \عددی{\theta=\pi-2\alpha} ہوں گے۔ یوں درج ذیل ہوگا۔
\begin{align}
...
\end{align}
ہو گا۔ اس مثال میں تفریقی عمودی تراش \عددی{\theta} کا تابع نہیں ہے،  جو ایک غیر معمولی بات ہے۔
\انتہا{مثال}
...
\end{align}
ہو گا، جو ہمارے توقعات کے عین مطابق ہے: یہ کرہ کا رقبہ عمودی تراش ہے؛ اس رقبہ  کے اندر  آمدی چھرے  ہدف کو  مار پائیں گے،  جبکہ اس سے باہر چھرے ہدف کو خطا کریں گے۔ یہی تصورات  \قول{نرم}  اہداف ( جیسا مرکزہ کا کولمب میدان) کے لئے بھی کار آمد ہے،  جن میں صرف نشانے پر \قول{لگنا  یا   نہ لگنا} نہیں بلکہ اس    کے علاوہ بھی  بات کی جائے گی۔
...
\end{align}
یہاں بھی میں فرض کرتا ہوں کہ ہدف اسّمتی تشاکلی ہے زیادہ عمومی صورت میں رخصتی کروی موج کا حیطہ \عددی{f} متغیرات \عددی{\phi} اور \عددی{\theta} کا تابع ہوگا۔
\begin{figure}
\centering
...
ہمیں حیطہ بکھراو \عددی{f(\theta)} تعین کرنا  ہوگا۔ یہ ہمیں کسی مخصوص رخ \عددی{\theta} میں بکھراو کا احتمال دیتا ہے اور یوں اس کا تعلق تفریقی عمودی تراش سے ہوگا۔ یقیناً سمتی رفتار \عددی{v} پر چلتے ہوئے ایک آمدی ذرہ کا وقت \عددی{\dif t} میں لامتناہی چھوٹی رقبہ \عددی{\dif\sigma} میں سے گزرنے کا احتمال   (شکل \حوالہ{شکل_بکھراو_رقبہ_حجم_شعاع}  دیکھیں)  درج ذیل ہوگا
\begin{align*}
...
\end{align}
حیرانی کی بات ہے کہ بکھراو عمودی تراش کی قیمت ہندسی عمودی تراش کے چار گنا ہے۔ درحقیقت \عددی{\sigma} کی قیمت کرہ کی کل سطحی رقبہ کے برابر ہے۔ لمبی طول موج بکھراو کی ایک خاصیت بڑی معاصر جسامت ہے جو بصریات میں بھی ہوگا۔ ایک لحاظ سے یہ امواج کرہ کو چھوتے ہوئے اس کے اُوپر سے گزرتے ہیں نہ کہ کلاسیکی ذرات کی طرح جنہیں صرف سیدھا دیکھتے ہوئے عمودی تراش نظر آتا ہے۔
\انتہا{مثال}
\ابتدا{سوال}
