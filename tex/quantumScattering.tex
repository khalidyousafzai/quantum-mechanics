...
%KKKK edited till here 26 feb 2022
...
\end{align*}
یوں بالخصوص \عددی{e^{ikz}} کو اس طرح بیان کرنا ممکن ہونا چاہیے اب مبدا پر \عددی{e^{ikz}} متناہی ہے لہٰذا نیومن تفاعلات کی اجازت نہیں ہوگی \عددی{r=0} پر \عددی{n_{\ell}(kr)} بے قابو بڑھتے ہیں اور چونکہ \عددی{z=r\cos\theta} میں کوئی \عددی{\phi} نہیں پایا جاتا ہے لہٰذا صرف \عددی{m=0} اجزاء ہوں گے۔ مستوی موج کی کروی امواج کی صورت میں صریحاً پھیلاو کلیہ ریلے دیتی ہے۔
\begin{align}
	e^{ikz} = \sum_{\ell=0}^{\infty}i^{\ell}(2l+1)j_{\ell}(kr)P_{\ell}(\cos\theta)
\end{align}
اس کو استعمال کرتے ہوئے بیرونی خطہ میں تفاعل موج کو صرف \عددی{r} اور \عددی{\theta} کی صورت میں پیش کیا جا سکتا ہے
\begin{align}
